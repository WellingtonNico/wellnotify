class WellNotify {
  ...
  obterRegrasCss = () => {
    ...
    return `
      <style>
        ...
        #${idContainerNotificacao} {
          --notificacao-container-padding: 15px;
          --notificacao-max-width:350px;
          --notificacao-success-color: #09B30E;
          --notificacao-error-color: #E44334;
          --notificacao-info-color: #2C8DD6;
          --notificacao-warning-color: #EFBC10;
          --notificacao-default-color: #7942AC;
          --notificacao-barra-wrapper-color: #d4d3d2;
          --notificacao-text-color: gray;
          --notificacao-background-color: white;
          --notificacao-botao-fechar-color:black;
          --notificacao-border-color:var(--notificacao-default-color);
        }
    
        
        [data-bs-theme='dark'] #${idContainerNotificacao},    
        [data-theme='dark'] #${idContainerNotificacao} {
          --notificacao-text-color: white;
          --notificacao-background-color: black;
          --notificacao-botao-fechar-color:gray;
          --notificacao-barra-wrapper-color: gray;
        }
    
        @media (max-width:365px) {
          #${idContainerNotificacao} {
            --notificacao-max-width: 100% !important;
            --notificacao-container-padding:0px;            
          } 
        }
        ...
        #${idContainerNotificacao}{
          ...
          ${regraHorizontal}          
          display: flex;
          padding: var(--notificacao-container-padding);          
          flex-direction: column;        
          max-width: var(--notificacao-max-width);
          width: var(--notificacao-max-width);
          min-width: var(--notificacao-max-width)
        }
    
        #${idContainerNotificacao} .notificacao_ContainerWrapper {      
          width: 100%;
          max-width: 100%;
          position:relative;      
          display: flex;
          ...
          margin-bottom: 8px;
          background-color: var(--notificacao-background-color);
          color: var(--notificacao-text-color);
        }
    
        #${idContainerNotificacao} .notificacao_IconeWrapper{
        ...
        #${idContainerNotificacao} .notificacao_ContainerWrapper .notificacao_Container{
          border-left:3px solid var(--notificacao-border-color);
          display: flex;
        }
    
        #${idContainerNotificacao} .notificacao_ContainerWrapper.success {
          --notificacao-border-color:var(--notificacao-success-color);
        }
    
        #${idContainerNotificacao} .notificacao_ContainerWrapper.error {
          --notificacao-border-color:var(--notificacao-error-color);
        }
    
        #${idContainerNotificacao} .notificacao_ContainerWrapper.warning {
          --notificacao-border-color:var(--notificacao-warning-color);
        }
    
        #${idContainerNotificacao} .notificacao_ContainerWrapper.info {
          --notificacao-border-color:var(--notificacao-info-color);
        }
    
        #${idContainerNotificacao} .notificacao_BotaoFecharWrapper{
          min-width: 20px !important;
          max-width: 20px !important;
          padding-right:2px;
        }
    
        #${idContainerNotificacao} .notificacao_BotaoFecharWrapper .notificacao_BotaoFechar{
          cursor:pointer;  
        }
    
        #${idContainerNotificacao} .notificacao_Mensagem{
          display:flex;
          align-items:center;
          flex-grow: 1;
        ...
        #${idContainerNotificacao} .notificacao_IconeLoading {

        }
    
        #${idContainerNotificacao} .notificacao_BarraProgressoWrapper{
          height: 3px;
          background-color: var(--notificacao-border-color);
          max-height:3px;
          display:flex;
          justify-content:end;      
        }
    
        #${idContainerNotificacao} .notificacao-BarraAnimada{
          height: 100%;
          transition: all ease;
          background-color: var(--notificacao-barra-wrapper-color);
        }
  ...
  icones = {
    success:
      '<svg viewBox="0 0 24 24" width="100%" height="100%" fill="var(--notificacao-success-color)"><path d="M12 0a12 12 0 1012 12A12.014 12.014 0 0012 0zm6.927 8.2l-6.845 9.289a1.011 1.011 0 01-1.43.188l-4.888-3.908a1 1 0 111.25-1.562l4.076 3.261 6.227-8.451a1 1 0 111.61 1.183z"></path></svg>',
    error:
      '<svg viewBox="0 0 24 24" width="100%" height="100%" fill="var(--notificacao-error-color)"><path d="M11.983 0a12.206 12.206 0 00-8.51 3.653A11.8 11.8 0 000 12.207 11.779 11.779 0 0011.8 24h.214A12.111 12.111 0 0024 11.791 11.766 11.766 0 0011.983 0zM10.5 16.542a1.476 1.476 0 011.449-1.53h.027a1.527 1.527 0 011.523 1.47 1.475 1.475 0 01-1.449 1.53h-.027a1.529 1.529 0 01-1.523-1.47zM11 12.5v-6a1 1 0 012 0v6a1 1 0 11-2 0z"></path></svg>',
    info:
      '<svg viewBox="0 0 24 24" width="100%" height="100%" fill="var(--notificacao-info-color)"><path d="M12 0a12 12 0 1012 12A12.013 12.013 0 0012 0zm.25 5a1.5 1.5 0 11-1.5 1.5 1.5 1.5 0 011.5-1.5zm2.25 13.5h-4a1 1 0 010-2h.75a.25.25 0 00.25-.25v-4.5a.25.25 0 00-.25-.25h-.75a1 1 0 010-2h1a2 2 0 012 2v4.75a.25.25 0 00.25.25h.75a1 1 0 110 2z"></path></svg>',
    warning:
      '<svg viewBox="0 0 24 24" width="100%" height="100%" fill="var(--notificacao-warning-color)"><path d="M23.32 17.191L15.438 2.184C14.728.833 13.416 0 11.996 0c-1.42 0-2.733.833-3.443 2.184L.533 17.448a4.744 4.744 0 000 4.368C1.243 23.167 2.555 24 3.975 24h16.05C22.22 24 24 22.044 24 19.632c0-.904-.251-1.746-.68-2.44zm-9.622 1.46c0 1.033-.724 1.823-1.698 1.823s-1.698-.79-1.698-1.822v-.043c0-1.028.724-1.822 1.698-1.822s1.698.79 1.698 1.822v.043zm.039-12.285l-.84 8.06c-.057.581-.408.943-.897.943-.49 0-.84-.367-.896-.942l-.84-8.065c-.057-.624.25-1.095.779-1.095h1.91c.528.005.84.476.784 1.1z"></path></svg>',
    close:
      '<svg aria-hidden="true" viewBox="0 0 14 16"><path fill="var(--notificacao-text-color)" d="M7.71 8.23l3.75 3.75-1.48 1.48-3.75-3.75-3.75 3.75L1 11.98l3.75-3.75L1 4.48 2.48 3l3.75 3.75L9.98 3l1.48 1.48-3.75 3.75z"></path></svg>',
  };
}
